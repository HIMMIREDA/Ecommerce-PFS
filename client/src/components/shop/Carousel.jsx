      ...
      {carouselItems?.map((carouselItem, index) => (
        ...
        >
          <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex  lg:items-center lg:px-8">
            <div className="max-w-xl text-center sm:text-left flex flex-col justify-center">
              ...
              <p className="mt-4 max-w-lg sm:leading-relaxed  font-bold text-2xl lg:text-3xl text-white">
              ...
              <div className="mt-8 flex flex-wrap gap-4 text-center  justify-center">
                <Link
                  ...
                  class="btn btn-warning group mt-auto flex w-44 cursor-pointer select-none items-center justify-center rounded-md  px-6 py-2 transition"
                >
                  <div class="group flex w-full items-center justify-center rounded py-1 text-center font-bold">
                    Shop now
                    <FiArrowRight class="flex-0 group-hover:w-6 ml-4 h-6 w-0 transition-all" />
                  </div>
                </Link>
              </div>
            </div>
