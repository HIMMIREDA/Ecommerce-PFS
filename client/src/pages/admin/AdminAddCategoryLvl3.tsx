...
function AdminAddCategoryLvl3() {
  ...
  const secondLvlCategories = categories.map((cat) => cat.subCategories).flat();

  return (
    <div className="container mx-auto mt-8">
      <h1 className="text-2xl font-bold mb-4">Add New Third-Level Category</h1>
...
export default AdminAddCategoryLvl3;
